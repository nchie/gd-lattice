...
void GridTerrain::_bind_methods() {
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "collision_layer", godot::PROPERTY_HINT_LAYERS_3D_PHYSICS),
    ...
    ADD_PROPERTY(PropertyInfo(Variant::INT, "collision_mask", godot::PROPERTY_HINT_LAYERS_3D_PHYSICS),
